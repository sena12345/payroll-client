  ...
  const onSubmit = (data) => {
    const employee = {
      ...
      positions: data.position
        ? [{ position_id: parseInt(data.position) }]
        : [],
      departments: data.department
        ? [{ department_id: parseInt(data.department) }]
        : [],
      allowances: data.allowance
        ? [{ allowance_id: parseInt(data.allowance) }]
        : [],
      designations: data.designation
        ? [{ designation_id: parseInt(data.designation) }]
        : [],
    };
    setLoading(true);
    empInstance
            ...
            <div className="col-50">
              ...
              <div className="form-row">
                ...
                <div className="col-50">
                  ...
                  />
                  {errors.cardnumber && (
                    <p className="valid">ID number is required!</p>
                  )}
                </div>
              </div>
              <div className="form-row">
